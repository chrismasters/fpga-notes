...
xst -ifn xst.scr
move clks_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clks_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clks_exdes.ucf clks_exdes

echo 'Running map'
map -timing -pr b clks_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clks_exdes -w routed.ncd routed.vhd
cd ..
