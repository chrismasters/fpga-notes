...
xst -ifn xst.scr
move vga_clk_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\vga_clk_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc vga_clk_exdes.ucf vga_clk_exdes

echo 'Running map'
map -timing -pr b vga_clk_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm vga_clk_exdes -w routed.ncd routed.vhd
cd ..
